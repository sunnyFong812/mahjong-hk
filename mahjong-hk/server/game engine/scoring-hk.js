...
const HK_SCORING = {
  general: {
    "無花": 1, "爛花": 1, "正花": 2, "無字": 1, "無字花": 8,
    "假獨": 1, "獨獨": 2, "對碰": 2, "將眼": 2,
    "正風": 1, "自摸": 1, "爛風": 1, "門前清": 5,
    "正位": 1, "門前清自摸": 10, "三元牌": 2,
    "聽牌": 5, "一發": 5, "食聽牌": 5, "聽牌自摸": 10
  },
  
  numbers: {
    "缺五": 5, "斷么九": 5,
    "四歸一": [5, 10], "四歸二": [10, 20], "四歸四": [30, 60],
    "雜龍": [10, 15], "清龍": [15, 20],
    "小於五": 60, "大於五": 60, "滿庭芳": 60
  },
  
  sequences: {
    "般高": [5, 10], "三般高": [20, 30], "四段高": [40, 60],
    "相逢": [3, 5], "三相逢": [10, 20],
    "三色三步高": [5, 10], "三色四步高": [15, 20], "三色五步高": [30, 40],
    "一色三步高": [10, 20], "一色四步高": [30, 40], "一色五步高": [60, 80]
  },
  
  patterns: {
    "雞糊": 30, "鴨糊": 15, "平糊": 5, "大平糊": 15,
    "對對糊": 40, "坎坎糊": 120, "廿二羅漢": 180,
    "全求人": 30, "半求人": 15,
    "缺一門": 5, "五門齊": [10, 15], "七門齊": [15, 20],
    "混一色": 40, "清一色": 100, "字一色": 150,
    "三元": [30, 60], "三風": [20, 40], "四喜": [60, 120]
  },
  ...
  pongs: {
    "兄弟": 5, "三兄弟": [10, 20],
    "姊妹": 5, "三姊妹": [10, 20], "四姊妹": [30, 50],
    "五姊妹": [60, 90], "六姊妹": 160,
    "二暗坎": 5, "三暗坎": 10, "四暗坎": 20, "五暗坎": 40
  },
  ...
  terminals: {
    "老少上": [3, 5], "老少碰": 5,
    "混帶么": 30, "全帶么": 60, "清么九": 200,
    "十三么": [120, 140], "十六不搭": [60, 70]
  },
